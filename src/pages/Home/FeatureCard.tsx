...
const FeatureCard: FC<{
  ...
  return (
    <motion.div
      className="animated-feature-cards relative h-full w-full drop-shadow-[0_0_15px_rgba(49,49,49,0.2)] dark:drop-shadow-[0_0_15px_rgba(49,49,49,0.2)]"
      ...
      >
        <div className="mx-10 my-10 w-full">
          <div className="mb-5 flex w-4/6 flex-col gap-3">
            <h2 className="text-x tracking-tight md:text-xl">
              {title}
            </h2>
